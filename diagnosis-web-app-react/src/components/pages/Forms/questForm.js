...
class QuestForm extends React.Component {
  ...
  validatelast_name = (e) => {
    ...
    this.setState({
      ...
      last_nameError2:
        isNaN(last_name) ? null : 'Last name cannot contain number/cannot be empty'
    });
  }
  FirstChanged = (event) => {
  ...
  validatefirst_name = (e) => {
    ...
    this.setState({
      ...
      first_nameError2:
        isNaN(first_name) ? null : 'First name cannot contain number/cannot be empty'
    });
  }
  ...
  validatedate = (e) => {
    ...
    this.setState({
      ...
      dateError3:
        new Date(date_of_birth).getFullYear() > parseInt(new Date().getFullYear()) - 99 ? null : 'Are you older than 99?',
    });
  }
  onRadioChange = (e) => {
    this.setState({
